...
define
    ...
    EitherWeAbortOrThereAreNoErrors == <>[]( abort \/  { nodes[n]: n \in 1..Nodes } = { "built" })
end define;
...
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-a7099637ae86eeab2d9c4a20b2307619
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-0b450fdd6d4877593bbc4ae92001acab

=============================================================================
\* Modification History
\* Last modified Wed Sep 09 19:14:03 CEST 2020 by ostera

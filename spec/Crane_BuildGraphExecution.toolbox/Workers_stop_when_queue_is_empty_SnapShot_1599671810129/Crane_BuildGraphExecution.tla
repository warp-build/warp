...
define
    ...
    EitherWeAbortOrThereAreNoErrors == <>[]( abort \/  Statuses = { "wat" })
end define;
...
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-d6268045a0e4c2e7bf108fbf94ca21d1
...
EventuallyQueueIsConsumed == <>[]( abort \/ (~abort /\ queue = 0 ))
NoWorkIsDoneTwice == <>[]( abort \/ (~abort /\ work_done = 1..Nodes ) )
EitherWeAbortOrThereAreNoErrors == <>[]( abort \/  { nodes[n]: n \in 1..Nodes } = { "wat" })
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-ec273e527c48d6b1bb3344fa4de2d8e4

=============================================================================
\* Modification History
\* Last modified Wed Sep 09 19:16:35 CEST 2020 by ostera

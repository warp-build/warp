...
define
    ...
    EitherWeAbortOrThereAreNoErrors == <>[]( abort \/  Statuses \subseteq { "built", "cached" })
end define;
...
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-4ec688caac4ed19f1ff8572f8f63bbd3
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-d574d89ac525385ef3de9063ca0aeecb

=============================================================================
\* Modification History
\* Last modified Wed Sep 09 19:28:59 CEST 2020 by ostera

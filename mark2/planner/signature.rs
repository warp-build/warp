...
/*
 * TODO(@ostera): this conversion should go away
 *
impl From<Signature> for Target {
    fn from(mut sig: Signature) -> Self {
        sig.config
            .insert("name".to_string(), CfgValue::Target(sig.name.clone()));
...
/* TODO(@ostera): one would hope we'd be able to get rid of this reparenting of targets.
impl SignaturesFile {

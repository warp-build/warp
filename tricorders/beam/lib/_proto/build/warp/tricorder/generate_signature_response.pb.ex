defmodule Build.Warp.Tricorder.GenerateSignatureResponse do
  @moduledoc false
  ...
  field :ok, 1, type: Build.Warp.Tricorder.GenerateSignatureSuccessResponse, oneof: 0

  field :missing_deps, 3,
    type: Build.Warp.Tricorder.GenerateSignatureMissingDepsResponse,
    json_name: "missingDeps",
    oneof: 0
end
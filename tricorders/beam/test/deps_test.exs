defmodule TricorderDepsTest do
  ...
  test "scans dependencies" do
    assert [
             %{
               castore: %{host: "hexpm", package: "castore", protocol: :hexpm, version: "0.1.22"},
               cowboy: %{host: "hexpm", package: "cowboy", protocol: :hexpm, version: "2.9.0"},
               cowlib: %{host: "hexpm", package: "cowlib", protocol: :hexpm, version: "2.11.0"},
               glob: %{host: "hexpm", package: "glob", protocol: :hexpm, version: "1.0.0"},
               google_protos: %{
                 host: "hexpm",
                 package: "google_protos",
                 protocol: :hexpm,
                 version: "0.3.0"
               },
               grpc: %{host: "hexpm", package: "grpc", protocol: :hexpm, version: "0.5.0"},
               gun: %{host: "hexpm", package: "grpc_gun", protocol: :hexpm, version: "2.0.1"},
               hex_core: %{host: "hexpm", package: "hex_core", protocol: :hexpm, version: "0.9.0"},
               hpax: %{host: "hexpm", package: "hpax", protocol: :hexpm, version: "0.1.2"},
               jason: %{host: "hexpm", package: "jason", protocol: :hexpm, version: "1.4.0"},
               mint: %{host: "hexpm", package: "mint", protocol: :hexpm, version: "1.5.1"},
               protobuf: %{
                 host: "hexpm",
                 package: "protobuf",
                 protocol: :hexpm,
               ...
               ranch: %{host: "hexpm", package: "ranch", protocol: :hexpm, version: "1.8.0"}
             }
           ] = Tricorder.Deps.scan(".")
  end
end

  ...
  <div @click="toggleMenu()" class="relative mt-1">
    ...
    <!--
      ...
      Leaving: "transition ease-in duration-100"
        ...
        To: "opacity-0"
    -->
    <ul v-show="menuOpen" class="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-3">
      <!--
      ...
      <li v-for="item in $props.repositories" :key="item.node_id" class="text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9" id="listbox-option-0" role="option">
        ...
        -->
        <span v-show="item.selected" class="text-indigo-600 absolute inset-y-0 right-0 flex items-center pr-4">

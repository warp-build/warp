  ...
  <main>
    <div class="mx-auto mt-12 max-w-7xl py-6 sm:px-6 lg:px-8">
      ...
      <div class="mx-auto mt-12 max-w-xl sm:mt-12">
        ...
        <div class="mt-6">
          <button :disabled="buttonIsDisabled" @click="runQuery" type="submit" class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">

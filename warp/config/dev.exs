...
config :warp, SharedCache.Artifactory,
  store: Warp.SharedCache.Artifactory.S3

config :warp, SharedCache.Artifactory.S3,
  bucket_name: "local.abstractmachines.warp.artifacts"
